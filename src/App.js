...
//createContext'in değeri her zaman true.
// Bu durumda, genel olarak AuthContext kullanımı herhangi bir yetkilendirme veya kimlik doğrulama işlemi yapmıyor gibi görünüyor.
//Eğer bu context ile bir yetkilendirme kontrolü yapmak istedigimizi varsayarak,
// bu context'in değerini bir state içinde tuttum.
...
export default function Header() {
  ...
  return (
    ...
    </AuthContext.Provider> //AuthContext'i bir Provider ile sarmalayarak alt bileşenlere değer sağlamamız gerekiyor.
  );
}
  ...
  return (
    <li>
      <ul role="list" className="-mx-2 space-y-1">
        {[...unAuthLinks, ...authLinks].map((item) => (
          <li key={item.name}>
            <a
              href={item.href}
